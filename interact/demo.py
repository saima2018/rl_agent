...
from utils_project import track, trackX, schedule
import ipdb
...
def main(res_dir, settings, hparams_list, paths_list, prints_dict, T_total=100):
    # paths = paths_list[0]
    ...
    saved_path = '/home/sai/Documents/DOM-Q-NET/entries/official/results/medium3_tasks_jul7/ckpt5000'
    ...
    if settings.get("multi_env", False):
        ...
        actor = dqn_actor.Actor(
                env_f, None, q_net,
                T_total, None, None,
                qlearn_hs["max_step_per_epi"], None, None, device, batch_device='cuda:0'
                )
        q = input("START")
        while True:
...
if __name__ == '__main__':
    ...
    service = Service(executable_path='/home/sai/Downloads/chromedriver_linux64/chromedriver')
    driver = webdriver.Chrome(service=service)
    driver.get('file:///home/sai/Documents/DOM-Q-NET/miniwob_project/html/miniwob/choose-list.html')
