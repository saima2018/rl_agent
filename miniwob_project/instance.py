...
class MiniWoBInstance:
    ...
    def __init__(
            ...
            wait_ms=1., block_on_reset=True, refresh_freq=0
            ):
        """
        E.g. base_url='file:///h/sheng/DOM-Q-NET/miniwob_project/html/miniwob_project/',
        Args:
        ...
        #NOTE Chrome driver
        base_url = 'file:///home/sai/Documents/DOM-Q-NET/miniwob_project/html/miniwob'
        url = base_url + task_file
...
if __name__ == '__main__':
    ins = MiniWoBInstance('/choose-list.html')
